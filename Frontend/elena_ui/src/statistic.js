  ...
  render() {
    return (
      <div className="container">
        ...
        <div key={this.props.key3} className="info">Elevation: {this.props.totalElevation}m</div>
        <div key={this.props.key4} className="info">Distance: {this.props.distance}m</div>
      </div>
    )
  }
